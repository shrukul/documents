...
public class Steganography_Controller
{
	...
	private class Encode implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
            ...
            System.out.println("Showing the Encode View");
		}
	}
	...
	private class Decode implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
            System.out.println("Showing the Decode View");
			decode_view();
			...
			if (returnVal == JFileChooser.APPROVE_OPTION){
				...
				try{
                    ...
                    System.out.println("File name selected is : "+stat_name);
	...
	private class EncodeButton implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
            System.out.println("Showing the Encode File Chooser");
			JFileChooser chooser = new JFileChooser("./");
			chooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
			chooser.setFileFilter(new Image_Filter());
			int returnVal = chooser.showOpenDialog(view);
			if (returnVal == JFileChooser.APPROVE_OPTION){
				...
				try{
                    ...
                    System.out.println("Name of the file selected is : "+name);
