/**
 *  @file dijkstra.cpp
 *  @brief Implementation of Dijsktra's algorithm using Binary Heap, Binomial Heap and Fibonacci Heap
 *
 *  @date 15 April 2016
 *
...
/**
  * @brief Binomial Heap Data Structure class
*/
class BinomialHeap
{
    private:
...
/**
  * @brief Fibonacci Heap Data Structure class
*/
class FibonacciHeap
{
    private:
...
int main() {
    ...
    //nodes--;
    for(i=0; i<edges; i++) {
        printf("Enter the edge parameters (src, dest, weight) : ");
        scanf("%d %d %d", &u, &v, &w);
        G[u].pb(pii(v, w));
