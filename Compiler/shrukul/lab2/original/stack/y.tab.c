...
{
  "$end", "error", "$undefined", "IDENT", "NUMBER", "ASSIGN", "PLUS",
  "LBRACE", "RBRACE", "LPAREN", "RPAREN", "SEMI", "ERROR", "FLOAT",
  "INTEGER", "IF", "THEN", "ELSE", "WHILE", "RETURN", "GOTO", "READ",
  "WRITE", "VOID", "CHAR", "NE", "EQ", "LT", "LE", "GT", "GE", "AND", "OR",
  "MINUS", "TIMES", "OVER", "MOD", "INT", "REAL", "LBRACK", "RBRACK",
  "COMMA", "CHRLIT", "STRLIT", "$accept", "block", "stmt_seq", "stmt",
  "decl", "expr", "assignmnt", "term", "decltype", YY_NULLPTR
};
#endif
...
{
      21,    -7,    13,    13,     1,    12,     0,    -7,    -7,    -7,
      -1,    14,    -7,     4,    -7,    -7,    26,     5,    -7,    17,
      -7,    -7,    20,    -7,    17,    -7,    -7,    -7,     4,    -7,
      -7
};
...
{
       0,     4,     0,     0,     0,     7,    17,    16,    19,    18,
       0,     0,     9,     8,    10,    14,     0,     0,     1,     0,
      11,     2,     0,     6,     0,    12,     3,    17,    15,     5,
      13
};
...
{
      20,    18,     6,     7,    22,    19,    20,    21,     6,     7,
      24,    22,     8,     9,     5,    26,     6,     7,     8,     9,
      27,     7,     1,   -11,     0,    23,     8,     9,     2,    25,
       3,    29,    17,    30,    28
};

static const yytype_int8 yycheck[] =
{
       1,     0,     3,     4,    10,     5,     1,     8,     3,     4,
       6,    17,    13,    14,     1,    10,     3,     4,    13,    14,
       3,     4,     1,    11,    -1,    11,    13,    14,     7,     3,
       9,    11,     3,    24,    19
};
...
{
       0,     1,     7,     9,    45,     1,     3,     4,    13,    14,
      46,    47,    48,    49,    50,    51,    52,    46,     0,     5,
       1,     8,    47,    11,     6,     3,    10,     3,    49,    11,
      51
};
...
#line 61 "parse.y" /* yacc.c:1646  */
    { 
                setType((yyvsp[0].tokname),(yyvsp[-1].tokid));
                fprintf(stdout,"set decltype to: %d for %s\n",(yyval.tokid),(yyvsp[0].tokname));  
            }
...
#line 77 "parse.y" /* yacc.c:1646  */
    { (yyval.tokid) = lookupType((yyvsp[0].tokname)); }
...
#line 82 "parse.y" /* yacc.c:1646  */
    { (yyval.tokid) = INT_TYPE; }
#line 1395 "y.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 83 "parse.y" /* yacc.c:1646  */
    { (yyval.tokid) = REAL_TYPE; }
